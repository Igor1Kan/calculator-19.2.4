...
class Calculator:
    def __init__(self, master):
        ...
        self.button_clear = ttk.Button(self.master, text="C", command=self.clear)
        self.button_add = ttk.Button(self.master, text="+", command=self.add)
        self.button_equal = ttk.Button(self.master, text="=", command=self.equal)
        self.button_subtract = ttk.Button(self.master, text="-", command=self.subtract)
        self.button_multiply = ttk.Button(self.master, text="*", command=self.multiply)
        self.button_divide = ttk.Button(self.master, text="/", command=self.divide)
        self.button_floor_div = ttk.Button(self.master, text="//", command=self.floor_div)
        self.button_modulus = ttk.Button(self.master, text="%", command=self.modulus)
        self.button_sqrt = ttk.Button(self.master, text="√", command=self.sqrt)
        self.button_neg = ttk.Button(self.master, text="+/-", command=self.neg)
